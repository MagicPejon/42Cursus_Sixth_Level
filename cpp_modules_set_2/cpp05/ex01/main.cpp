...
/*   Updated: 2023/08/12 17:11:48 by amalbrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	Form request("Fire", 50, 25);
	try
	{
		request.beSigned(jest);	
	}
	catch(const std::exception & e)
	{
		std::cerr << e.what() << std::endl;
	...
	std::cout << "------------Form Failed Test----------" << std::endl;
	try
	{
		Form messy("Big Bang", 125, -5);
	}
	catch(const std::exception & e)
	{
		std::cerr << e.what() << std::endl;
